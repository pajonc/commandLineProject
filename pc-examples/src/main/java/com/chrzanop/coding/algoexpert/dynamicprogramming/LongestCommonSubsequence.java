...
public class LongestCommonSubsequence {
    ...
    // O(nm) time | O(nm) space where n - length of str1, m - length of str2
    public static List<Character> longestCommonSubsequenceAlgo2(String str1, String str2) {
